...
public class NPCInteraction : MonoBehaviour
{
    ...
    {
        // LLM 호출 시작 => 응답 처리 및 출력은 chatManager 내부에서 처리
        // Action<object> 파라미터 처리	현재 안 쓰므로 null 전달 나중에 쓰면 확장 가능
        StartCoroutine(chatManager.GetChatResponse(concept, prompt, null));
    }
}
